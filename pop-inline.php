...
<link rel='stylesheet' id='colors-css'  href='http://localhost:8888/wordpress/wp-admin/css/colors-classic.css?ver=20091217' type='text/css' media='all' />
				...
				<div class="meta-box-sortables ui-sortable">
					<div class="postbox ">
						...
						<div id="kish_multi_wp_resultDiv_1">
							...
							<div class="metabox-holder">
									<div class="postbox-container" style="width:18%;display:inline;">
											<div class="postbox ">
												<div class="handlediv" title="Click to toggle"><br></div><h3 class="hndle"><span>Some Help Here</span><span id="kish_multi_wp_sitename_prog"></span></h3>
												<div class="inside" id="kish_multi_wp_new_post_sidebar" style="font-size:11px;display:block;overflow:hidden;padding:5px">
													...
													<div id="km_twitter_search">Twitter Search</div>
												</div>
								...
								<div class="metabox-holder" style="margin-top:-40px">
									<div class="postbox-container" style="width:74%;display:inline;float:right">
											<div class="postbox ">
												<div class="handlediv"><br></div><h3 class="hndle"><span>New Post to be post on <span id="kmwp-pt"><?php echo $k->getTitle(); ?></span></span></h3>
												<div class="inside" id="kish_multi_wp_new_post_create_cont" style="font-size:11px;display:block;overflow:hidden;padding:5px">
												<?php kish_multi_wp_new_post_form_print(get_site_option('km_default_blog'), $_GET['s']); ?>
												</div>
