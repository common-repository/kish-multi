...
<script type="text/javascript" src="/example/scripts/jquery.uploadify.v2.0.0.min.js"></script>
...
<p><a href="javascript:jQuery('#uploadify').uploadifyClearQueue()">Cancel All Uploadssss</a></p>
</body>
</html>
